...
Route::group(['middleware' => 'auth'], function(){
    Route::get('/', [PurchasingorderController::class, 'index'])->name('home');
    Route::get('/dataTable', [PurchasingorderController::class, 'serversideTable']);
    Route::resource('purchasing-order', PurchasingorderController::class)->except(['index']);
    Route::get('/get-pekerjaan/{clientId}', [PekerjaanController::class, 'getPekerjaan']);
    ...
    Route::resource('klien', ClientController::class)->except(['index']);
    ...
    Route::resource('karoseri', KaroseriController::class)->except(['index']);
    ...
    Route::resource('pekerjaan', PekerjaanController::class)->except(['index']);
    ...
    Route::resource('pic', PersoninchargeController::class)->except(['index']);
    ...
    Route::resource('subkontraktor', SubkontraktorController::class)->except(['index']);
